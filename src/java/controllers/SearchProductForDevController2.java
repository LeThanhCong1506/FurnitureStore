 ...
 * @author ASUS
 */
@WebServlet(name = "SearchProductForUserController", urlPatterns = {"/SearchProductForUserController"})
public class SearchProductForDevController2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (productname == null||productname.isEmpty()) { 
            ...
            readingUser.setName(productname);
            ArrayList<ProductDTO> existedProduct = new ProductDAO().search(readingUser);
