                ...
                <div class="app-container">
                    ...
                    <div class="app-hero-header">
                        ...
                        <h3 class="fw-light mb-5">
                            <span>Home</span> / <span class="menu-text">Product list</span> / <span class="menu-text">Product modify</span>
                        </h3>
                    </div>
                                        ...
                                        <div class="custom-tabs-container">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="oneA" role="tabpanel">
                                                    <%
                                                        ProductDTO productModify = (ProductDTO) request.getAttribute("modifyProduct");
                                                    ...
                                                    <form action="MainController" method="POST">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="fullName" name="name" placeholder="Name"  value="<%= productModify.getName()%>"/>
                                                                                </div>
                                                                                <!-- Form Field Start -->
                                                                                <div class="mb-3">
                                                                                    <label for="userName" class="form-label">Id</label>
                                                                                    <input type="text" class="form-control" id="userName" name="id" placeholder="Username" value="<%= productModify.getId()%>" readonly=""/>
                                                                                </div>
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input type="text" class="form-control" name="type" id="contactNumber"
                                                                                           placeholder="Type" value="<%=productModify.getType()%>" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-6">
                                                                                <!-- Form Field Start -->
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input type="text" class="form-control" name="quantity" id="emailId" placeholder="Quantity"
                                                                                           value="<%= productModify.getQuantity()%>" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12">
                                                                                <!-- Form Field Start -->
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <textarea class="form-control" name="description" rows="3"><%= productModify.getDescription()%></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <!-- Row end -->
                                                                            ...
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input type="text" class="form-control"  id="currentPassword"
                                                                                           placeholder="Image" value="<%= productModify.getImage()%>"/>
                                                                                    <image src="images/<%=productModify.getImage()%>" style="width: 48.3%; margin-left: 90px; margin-top: 20px; margin-bottom: 20px;"><br>
                                                                                </div>

                                                                            </div>
                                                                            <div class="col-6">
                                                                                <div class="mb-3">
                                                                                    <label for="currentPassword" class="form-label">Image replacement</label><br>
                                                        ...
                                                        <div class="d-flex gap-2 justify-content-end">
                                                            <button type="submit"  class="btn btn-primary">
                                                                <a href="UpdateProduct" style="color: white;text-decoration: none " >Reset</a>
                                                            </button>
                                                            <button type="submit" name="action" value="DeleteProductForDev" class="btn btn-primary">
                                                                Delete
                                                            </button>
                                                            <button type="submit" name="action" value="UpdateProductForDev" class="btn btn-primary">
                                                                Update
                                                            </button>
                                                        </div>
                                                    </form>
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label for="fullName" class="form-label">Name</label>
                                                                                    <input type="text" class="form-control" id="fullName" name="name" placeholder="Name"  value="<%= productModify.getName()%>" readonly=""/>
                                                                                </div>
                                                                                <!-- Form Field Start -->
                                                                                <div class="mb-3">
                                                                                    <label for="userName" class="form-label">Id</label>
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label for="contactNumber" class="form-label">Type</label>
                                                                                    <input type="text" class="form-control" name="type" id="contactNumber"
                                                                                           placeholder="Type" value="<%=productModify.getType()%>"  readonly=""/>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-6">
                                                                                <!-- Form Field Start -->
                                                                                <div class="mb-3">
                                                                                    <label for="emailId" class="form-label">Price</label>
                                                                                    <input type="text" class="form-control" name="price" id="emailId" placeholder="Price"
                                                                                           value="<%= productModify.getPrice()%>"  readonly=""/>
                                                                                </div>
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label for="emailId" class="form-label">Sale(1:yes,0:no)</label>
                                                                                    <input type="text" class="form-control" name="sale" id="emailId" placeholder="Sale"
                                                                                           value="<%= productModify.getSale()%>" readonly="" />
                                                                                </div>
                                                                                <div class="mb-3">
                                                                                    <label for="emailId" class="form-label">Quantity</label>
                                                                                    <input type="text" class="form-control" name="quantity" id="emailId" placeholder="Quantity"
                                                                            ...
                                                                            <div class="col-12">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label class="form-label">Description</label>
                                                                                    <input class="form-control" name="des" value="<%= productModify.getDescription()%>"  readonly=""></input>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <!-- Row end -->
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label for="currentPassword" class="form-label">Image</label>
                                                                                    <input type="text" class="form-control" name="image" id="currentPassword"
                                                                                           placeholder="Image" value="<%= productModify.getImage()%>"  readonly=""/>
                                                                                    <image src="images/<%=productModify.getImage()%>" style="width: 30%;">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
