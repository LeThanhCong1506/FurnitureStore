<%-- 
    Document   : single-product.jsp
    Created on : Jun 26, 2024, 12:41:58 AM
    Author     : ASUS
--%>
...
<html lang="en">
            ...
            <ul class="list-unstyled d-flex m-0">
                <ul class="list-unstyled d-flex m-0">
                    <li class="d-none d-lg-block">
                        <a href="Wishlist" class="text-uppercase mx-3">Wishlist <span class="wishlist-count">()</span>
                        </a>
                    </li>
                    <li class="d-none d-lg-block">
                        <a href="Cart" class="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">Cart <span class="cart-count">(<%=listCart.size()%>)</span>
                        </a>
                    </li>
                    <li class="d-lg-none">
                        <a href="#" class="mx-2">
    ...
    <main class="main-content mt-5 py-5">
        <div class="container">
        ...
        <%
            ProductDTO sg = (ProductDTO) request.getAttribute("singleProduct");
            if (sg != null) {
        %>

        <section id="product-detail" class="single-product">
            <div class="container">
                <div class="row g-5">
                    <div class="col-md-7">
                        <div class="row flex-column-reverse flex-lg-row">
                            <div class="col-md-12 col-lg-2">
                                ...
                                <div class="swiper product-thumbnail-slider vertical" data-num="6" data-direction="vertical">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="images/<%=sg.getImage()%>" alt="thumb-image" class="thumb-image img-fluid">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="images/<%=sg.getImage()%>" alt="thumb-image" class="thumb-image img-fluid">
                                        </div>
                            ...
                            <div class="col-md-12 col-lg-10">
                                ...
                                <div class="swiper product-large-slider">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="image-zoom" data-scale="2.5" data-image="images/<%=sg.getImage()%>"><img
                                                    src="images/<%=sg.getImage()%>" alt="product-large" class="img-fluid"></div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image-zoom" data-scale="2.5" data-image="images/<%=sg.getImage()%>"><img
                                                    src="images/<%=sg.getImage()%>" alt="product-large" class="img-fluid"></div>
                    ...
                    <div class="col-md-5">
                        <div class="product-info">
                            <div class="element-header">
                                <h2 itemprop="name" class="display-4 fw-bold"><%=sg.getName()%></h2>
                            ...
                            <div class="product-price">
                                <%
                                    if (sg.getSale() == 1) {
                                        ...
                                        double price = ((double) sg.getPrice()) * 1.2;
                                        DecimalFormat df = new DecimalFormat("#.##");
                                        String formattedNumber = df.format(price);
                                %>
                                <span class="fs-2"><%=sg.getPrice()%></span>
                                <del><%=formattedNumber%></del>
                                <%
                                } else {
                                %>
                                <span class="fs-2"><%=sg.getPrice()%></span>
                            ...
                            <form action="MainController" method="POST">
                                ...
                                <div class="product-action mt-4">
                                    <div class="item-title"><%=sg.getQuantity()%> in stock</div>
                                    <div class="product-quantity d-flex flex-wrap gap-3">
                                        ...
                                        <div class="input-group product-qty" style="max-width: 150px;">
                                            ...
                                            <!-- N?u ??u vào ?n là c?n thi?t cho vi?c truy?n ID, hãy gi? nó l?i và thay ??i ID ?? tránh xung ??t -->
                                            <input type="hidden" id="product-id" name="productId" class="form-control input-number text-center" value="<%=sg.getId()%>" min="1" max="100">
                                            <!-- ??u vào chính ?? thay ??i s? l??ng -->
                                        ...
                                        <button type="submit" id="add-to-cart"
                                                class="btn btn-dark product-cart-submit text-uppercase" name="action" value="AddToCart">
                                            <span id="add-to-cart">Add to cart</span>
                                        </button>

                                        <button class="btn btn-dark wish-list-button bg-dark">
                                        ...
                                        <div class="cate-links d-flex flex-column mt-4">
                                            <div class="cate-tag d-flex mb-3">
                                                ...
                                                <div class="tag-item d-flex">
                                                    <a href="#"> Living</a>, <a href="#"> Wooden</a>, <a href="#"> Yellow</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-7">
                                                <div class="review-content">
                                                    ...
                                                    <div class="review-header">
                                                        ...
                                                        <span class="review-date">â 07/05/2022</span>
                                                    </div>
                                ...
                                <div class="add-review mt-5">
                                    ...
                                    <form id="form" class="form-group">
                                            ...
                                            <div class="review-rating">
                                                ...
                                                <div class="rating-container d-flex align-items-center">
                                                    <div class="rating" data-rating="1">
                                                        <svg width="24" height="24" class="text-warning"><use xlink:href="#star-solid"></use></svg>
                                                    </div>
                                        ...
                                        <div class="pb-3">
                                            ...
                                            <textarea rows="6" class="form-control" placeholder="Write your review here"></textarea>
                                        </div>
                                        <div class="pb-3">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6 text-start text-md-end">
                        <p>Â© Copyright 2023 Classi. All rights reserved. HTML Template by <a href="https://templatesjungle.com" target="_blank">TemplatesJungle</a></p>
                    </div>
                </div>
            </div>
        </div>
