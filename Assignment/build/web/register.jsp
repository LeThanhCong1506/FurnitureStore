        ...
        <div class="container-sm">
            <div class="row justify-content-center">
                <div class="col-md-4">
                    ...
                    <h2 class="section-title text-uppercase">Register</h2>
                    <form action="MainController" method="post" id="form" class="form-group flex-wrap">
                        ...
                        <div class="col-12">
                            ...
                            %>
                            <button type="submit" name="action" value="Register" class="btn btn-dark text-uppercase w-100">Register</button>
                            <p>Had an account?<a href="Login" class="text-muted"> Click here</a></p>
                        </div>
                    </form>
                </div>
            </div>
