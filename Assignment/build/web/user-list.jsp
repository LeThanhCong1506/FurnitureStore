                ...
                <div class="app-container">
                    ...
                    <div class="app-hero-header">
                        ...
                        <h3 class="fw-light mb-5">
                            <span>Home</span> / <span>User List</span>
                        </h3>
                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="UpdateUser" method="POST">
                                                                <button type="submit" name="id1" value="<%= list.get(i).getUsername()%>" class="btn btn-outline-primary">Modify</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                    <%
                                            ...
                                            <table class="table align-middle">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="UpdateUser" method="POST">
                                                                <button type="submit" name="id1" value="<%= list.get(i).getUsername()%>" class="btn btn-outline-primary">Detail</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                    <%
