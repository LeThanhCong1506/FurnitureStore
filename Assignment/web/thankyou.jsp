        ...
        <div class="slideshow slide-in arrow-absolute text-white" style="height: 100vh;">
            <div class="swiper-wrapper">
                <div class="swiper-slide d-flex align-items-center jarallax">
                    <img src="images/backgroundfinal.jpg" class="jarallax-img" alt="slideshow">
                    <div class="banner-content w-100">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 offset-md-1">
                                    <h2 class="display-xl text-uppercase mt-5 pt-5 txt-fx slide-up">Thank You</h2>
                                    <p class="caption">Thank you for trusting and purchasing from us.</p>
                                    <a href="Home" class="btn btn-outline-light text-uppercase rounded-3 px-4 py-3 mt-3">Back to home</a>
                                </div>
                            </div>
                        </div>
                    </div>
