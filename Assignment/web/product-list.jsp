                                            ...
                                            <table class="table align-middle">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style=" width: 20%"><%=list.get(i).getName()%></td>
                                                        <td><image src="images/<%=list.get(i).getImage()%>" style="width: 20%"></td>
                                                        ...
                                                        <td>
                                                            <form action="UpdateProduct" method="POST">
                                                                <button type="submit" name="id1" value="<%= list.get(i).getId()%>" class="btn btn-outline-primary">Modify</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                    <%
