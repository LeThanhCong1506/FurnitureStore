                ...
                <div class="app-container">
                    ...
                    <div class="app-hero-header">
                        ...
                        <h3 class="fw-light mb-5">
                            <span>Home</span> / <span class="menu-text">Settings</span>
                        </h3>
                    </div>
                                            ...
                                            <ul class="nav nav-tabs" id="customTab2" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link" id="tab-threeA" data-bs-toggle="tab" href="#threeA" role="tab"
                                                       aria-controls="threeA" aria-selected="false">Cards</a>
                                                </li>
                                            </ul>
                                                    ...
                                                    <form action="MainController" method="POST">
                                                        ...
                                                        <div class="d-flex gap-2 justify-content-end">
                                                            <button type="submit"  class="btn btn-primary">
                                                                <a href="UpdateUser" style="color: white;text-decoration: none " >Reset</a>
                                                            </button>
                                                            <button type="submit" name="action" value="Update2" class="btn btn-primary">
                                                                Update
                                                            </button>
                                                        </div>
                                                    </form>
