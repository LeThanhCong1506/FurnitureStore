...
<html lang="en">
   ...
   <div class="search-popup">
    ...
    <section class="mt-5 pt-5 border-bottom">
        <div class="container-fluid" style="margin-top: 10px;">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="text-uppercase fs-3">Shop</h1>
        ...
        <section class="shopify-element py-5">
            <div class="container-fluid">
                <div class="d-flex justify-content-between py-1">
                    <div>
                        <span>Showing 10 of 155 results</span>
                    </div>
                    <div>
                ...
                <nav aria-label="Page navigation" class="d-flex justify-content-center mt-5">
                    <ul class="pagination">
                        ...
                        <li class="page-item active" aria-current="page"><a class="page-link" href="Shop">1</a></li>
                    ...
                    <div class="col">
                        <div class="product-item hover-effect-slide">
                            <div class="image-holder position-relative">
                                ...
                                <button class="btn btn-dark w-100 mt-2 rounded-3">Add to cart</button>
                            </div>
                            <div class="product-content">
                                <h5 class="element-title text-uppercase fs-5 mt-3">
                                    <a href="single-product.html"><%= list.get(i).getName()%></a>
