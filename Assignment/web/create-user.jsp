                ...
                <div class="app-container">
                    ...
                    <div class="app-hero-header">
                        ...
                        <h3 class="fw-light mb-5">
                            <span>Home</span> / <span class="menu-text">Create User</span>
                        </h3>
                    </div>
                                                    ...
                                                    <form action="MainController" method="POST">
                                                        ...
                                                        <div class="row justify-content-between">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input type="email" class="form-control" name="email" id="emailId" placeholder="info@email.com"
                                                                                            />
                                                                                </div>
                                                                            ...
                                                                            <div class="col-12">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input class="form-control" name="address" rows="2"></input>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <!-- Row end -->
                                                            ...
                                                            <div class="col-sm-4 col-12">
                                                                <div class="card shadow mb-4">
                                                                    <div class="card-header">
                                                                        <h5 class="card-title">Create Password</h5>
                                                                    </div>
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                        ...
                                                        <div class="d-flex gap-2 justify-content-end">
                                                            <button type="submit"  class="btn btn-primary">
                                                                <a href="CreateUser" style="color: white;text-decoration: none " >Reset</a>
                                                            </button>
                                                            <button type="submit" name="action" value="CreateUser" class="btn btn-primary">
                                                                Create
                                                            </button>
                                                        </div>
                                                    </form>
