                                ...
                                <div class="row align-items-center"> 
                                        ...
                                        <div class="cart-info d-flex flex-wrap align-items-center mb-4">
                                            <div class="col-lg-5">
                                                <div class="card-image">
                                                    <img src="images/<%=listCart.get(i).getProductImage()%>" alt="cloth" class="img-fluid">
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <div class="card-detail ps-3">
                                                    <h5 class="card-title">
                                                        <a href="#" class="text-decoration-none"><%=listCart.get(i).getProductName()%></a>
                                                    </h5>
                                                    <div class="card-price">
                                                        <span class="money text-dark" data-currency-usd="$1200.00"><%=listCart.get(i).getProductPrice()%></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row d-flex">
                                            <div class="col-md-4">
                                                <div class="input-group product-qty">
                                                    ...
                                                    <input type="text" id="quantity" name="quantity_<%=listCart.get(i).getProductId()%>" 
                                                           class="form-control input-number text-center" value="<%=listCart.get(i).getQuantity()%>" min="1" max="100">
                                                    <span class="input-group-btn">
                                            ...
                                            <div class="col-md-8 text-center">
                                                <div class="total-price">
                                                    <span class="money text-dark"><%=listCart.get(i).getTotalPrice()%></span>
                                                </div>
                                            </div>   
                                        </div>             
                                    </div>
                                    <div class="col-lg-1 col-md-2">
                                        <div class="cart-remove">
                                            <a href="MainController?action=DeleteCart&productId=<%=listCart.get(i).getProductId()%>">
                                                <svg width="32px">
                                    ...
                                    <div class="col-lg-4 col-md-3">
                                        <div class="cart-info d-flex flex-wrap align-items-center mb-4">
                                            <div class="col-lg-7">
                                                <div class="card-detail ps-3">
                                                    <h3 class="card-title">
                                                        <a href="#" class="text-decoration-none">Nothing here yet!</a>
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="cart-totals bg-grey py-5">
                                    ...
                                    <tbody>
                                        <tr class="subtotal pt-2 pb-2 border-top border-bottom">
                                            ...
                                            <td data-title="Subtotal">
                                                <span class="price-amount amount text-dark ps-5">
                                                    <bdi>
                                                        <span class="price-currency-symbol">$</span><%= String.format("%.2f", totalPrice)%>
                                                    </bdi>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr class="order-total pt-2 pb-2 border-bottom">
                                            ...
                                            <td data-title="Total">
                                                <span class="price-amount amount text-dark ps-5">
                                                    <bdi>
                                                        <span class="price-currency-symbol">$</span><%= String.format("%.2f", totalPrice + (totalPrice * 0.1))%> +TAXES</bdi>
                                                </span>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="button-wrap row g-2">
                                <%
                                    ...
                                    if (currentUser != null) {
                                %>
                                <div class="col-md-6"><button name="action" value="UpdateCart" class="btn btn-dark text-uppercase btn-rounded-none w-100">Update Cart</button></div>
                                <div class="col-md-6"><button class="btn btn-dark text-uppercase btn-rounded-none w-100"><a href="Shop" style="color: white">Continue Shopping</a></button></div>
                                ...
                                %>
                                <div class="col-md-6"><button type="button" class="btn btn-dark text-uppercase btn-rounded-none w-100">Update Cart</button></div>
                                <div class="col-md-6"><button class="btn btn-dark text-uppercase btn-rounded-none w-100"><a href="Shop" style="color: white">Continue Shopping</a></button></div>
                                <div class="col-md-12"><button  class="btn btn-primary text-uppercase btn-rounded-none w-100">Proceed to checkout</button></div>
                                <%
                                    }
