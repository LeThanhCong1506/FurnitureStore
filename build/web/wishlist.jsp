<%@page import="sample.wishlist.WishlistDTO"%>
...
<html lang="en">
    ...
    <section id="Wishlist" class="py-5 my-5">
        <div class="container">
            ...
            <%
                ArrayList<WishlistDTO> list = (ArrayList<WishlistDTO>) request.getAttribute("wishList");
                if (list == null) {
            ...
            <div class="product-wrapper">
                ...
                %>
                <div class="product-item row align-items-center mb-3 border-bottom">
                    <div class="col-4 col-md-1 d-flex align-items-center text-left">
                        <a href="#">
                            <img srcset="images/<%=list.get(i).getProductImage()%>" alt="wishlist" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-8 col-md-4">
                        <h3 class="item-title">
                            <a href="#"><%=list.get(i).getProductName()%></a>
                        </h3>
                    </div>
                    <div class="col-3 col-md-2 product-price text-left">
                        <span class="item-price">$<%=list.get(i).getProductPrice()%></span>
                    </div>
                    ...
                    <div class="col-3 col-md-2 wishlist-add text-left">
                        <form action="" method="post" class="variants">
                            <a class="btn btn-outline-dark text-uppercase" title="Add to Cart" 
                               href="MainController?action=AddToCart&productId=<%=list.get(i).getProductId()%>">Add To Cart</a>
                        </form>
                    </div>
                    <div class="col-3 col-md-1 text-left">
                        <div class="cart-remove">
                            <a href="MainController?action=AddToWish&idPro=<%=list.get(i).getProductId()%>">
                                <svg width="32px">
