...
<html lang="en">
    ...
    <head>
        <title>Classi - Furniture Shop</title>
        <meta charset="utf-8">
    ...
    <div class="search-popup">
        <div class="search-popup-container">
            ...
            <form role="search" method="POST" class="form-group" action="MainController" >
                <input type="search" id="search-form" class="form-control border-0 border-bottom"
                       placeholder="Type and press enter" name="searchproduct" />
                <button type="submit" name="action" value="SearchProduct2" class="search-submit border-0 position-absolute bg-white"
            ...
            <ul class="cat-list">
                <li class="cat-list-item">
                    <a href="MainController?searchtype=ModernChair&action=SearchProduct3" id="i1" title="Jackets">Modern</a>
                </li>
                <li class="cat-list-item">
                    <a href="MainController?searchtype=GamingChair&action=SearchProduct3" id="i1" title="Jackets">Gaming</a>
                </li>
                <li class="cat-list-item">
                    <a href="MainController?searchtype=ClassicChair&action=SearchProduct3" id="i1" title="Jackets">Classic</a>
                </li>
                <li class="cat-list-item">
                    <a href="MainController?searchtype=LuxuryChair&action=SearchProduct3" id="i1" title="Jackets">Luxury</a>
                </li>
                <li class="cat-list-item">
                    <a href="MainController?searchtype=OfficeChair&action=SearchProduct3" id="i1" title="Jackets">Office</a>
                </li>
                <li class="cat-list-item">
                    <a href="MainController?searchtype=ComfortableChair&action=SearchProduct3" id="i1" title="Jackets">Comfortable</a>
                </li>
            </ul>
    ...
    <nav
        class="navbar navbar-expand-lg navbar-light text-white text-uppercase fs-6 p-3 border-bottom border-light align-items-center fixed-top border-opacity-10">
        <div class="container-fluid">
            <a class="navbar-brand" href="Home"><img src="images/logo.png" width="100" height="55" alt="logo"></a>
    ...
    <section>
        <div class="slideshow slide-in arrow-absolute text-white" style="height: 100vh;">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 offset-md-1">
                                    <h2 class="display-xl text-uppercase mt-5 pt-5 txt-fx slide-up">Luxury</h2>
                                    <p class="caption">Tortor eget placerat arcu integer. Lectus fames egestas tincidunt aliquet vivamus
                                        nibh lorem nulla.</p>
                                    <a href="#" class="btn btn-outline-light text-uppercase rounded-3 px-4 py-3 mt-3">Shop Collection</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide d-flex align-items-center jarallax">
                    ...
                    <div class="banner-content w-100">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 offset-md-1">
                                    <h2 class="display-xl text-uppercase mt-5 pt-5 txt-fx slide-up">Modern</h2>
                                    <p class="caption">This is Modern fashion ectus fames egestas tincidunt aliquet vivamus nibh lorem
                                        nulla.</p>
                                    <a href="#" class="btn btn-outline-light text-uppercase rounded-3 px-4 py-3 mt-3">Shop Collection</a>
                                </div>
                            </div>
                ...
                <div class="swiper-slide d-flex align-items-center jarallax">
                    ...
                    <div class="banner-content w-100">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 offset-md-1">
                                    <h2 class="display-xl text-uppercase mt-5 pt-5 txt-fx slide-up">Classic</h2>
                                    <p class="caption">Tortor eget placerat arcu integer. Lectus fames egestas tincidunt aliquet vivamus
                                        nibh lorem nulla.</p>
                                    <a href="#" class="btn btn-outline-light text-uppercase rounded-3 px-4 py-3 mt-3">Shop Collection</a>
                                </div>
            ...
            <div class="row g-5">
                <div class="col-md-7">
                    <div class="jarallax position-relative mb-4" style="height: 480px;">
                        <img src="images/category-large-1.jpg" alt="categories" class="jarallax-img img-fluid">
                ...
                <div class="col-md-5">
                    <div class="jarallax position-relative mb-3" style="height: 480px;">
                        <img src="images/category-large-2.jpg" alt="categories" class="jarallax-img img-fluid">
                        <div class="category-content position-absolute bottom-0 p-5 text-uppercase">
                ...
                <div class="col-md-5">
                    <div class="jarallax position-relative mb-3" style="height: 480px;">
                        <img src="images/category-large-3.jpg" alt="categories" class="jarallax-img img-fluid">
                        <div class="category-content position-absolute bottom-0 p-5 text-uppercase">
                ...
                <div class="col-md-7">
                    <div class="jarallax position-relative mb-3" style="height: 480px;">
                        <img src="images/category-large-4.jpg" alt="categories" class="jarallax-img img-fluid">
                        <div class="category-content position-absolute bottom-0 p-5 text-uppercase">
                            <h4 class="section-title text-white">For Accessories</h4>
                            <a href="shop-four-column-wide.html" class="text-white btn-link">Shop it Now</a>
                        </div>
    ...
    <section class="py-5 my-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <h2 class="fs-2 text-center">Our lives happen around our furniture. Every day, our bed frames, dining tables, dressers, and
                        coffee tables support us, often without thanks and appreciation.</h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            ...
            <div data-aos="fade-in">
                <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5">
                    ...
                    <%
                        for (int i = 0; i < 5; i++) {
                            String input1Id = "input1_" + i;
                            String input2Id = "input2_" + i;
                    %>
                    <div class="col">
                        <div class="product-item hover-effect-slide">
                            <div class="image-holder position-relative">
                                ...
                                <form action="SingleProduct" method="POST">
                                    <!-- Dùng cách này c?ng ???c -->
                                    <!--                                    <a href="MainController?searchtype=ComfortableChair&action=SearchProduct3" id="i1" title="Jackets">Comfortable</a>-->
                                    <a id="<%= input1Id%>">
                                        <img src="images/<%= list.get(i).getImage()%>" alt="categories" class="product-image img-fluid">
                                    </a>
                                    <input type="hidden" name="id" value="<%= list.get(i).getId()%>" readonly=""/>
                                    <button id="<%= input2Id%>" type="submit" style="display: none"></button>
                                    <script>
                                        document.getElementById("<%= input1Id%>").addEventListener("click", function () {
                                            document.getElementById("<%= input2Id%>").click();
                                        });
                                    </script>
                                </form>

                                <a href="MainController?action=AddToWish&idPro=<%=list.get(i).getId()%>" class="btn-icon btn-wishlist">
                                ...
                                <form action="MainController" method="POST">
                                    ...
                                    <button class="btn btn-dark w-100 mt-2 rounded-3" name="action" value="AddToCart">Add to cart</button>
                                </form>
                            </div>
                ...
                <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5">
                    <%
                        ...
                        for (int i = 0; i < list.size(); i++) {
                            String input1Idd = "input11_" + i;
                            String input2Idd = "input22_" + i;
                            if (list.get(i).getSale() == 1) {
                                if (count != 5) {
                                    count++;
                    %>
                    <div class="col">
                        <div class="product-item hover-effect-slide">
                            <div class="image-holder position-relative">
                                ...
                                <form action="SingleProduct" method="POST">
                                    ...
                                    <input type="hidden" name="id" value="<%= list.get(i).getId()%>" readonly=""/>
                                    <button id="<%= input2Idd%>" type="submit" style="display: none"></button>
                                    <script>
                                        document.getElementById("<%= input1Idd%>").addEventListener("click", function () {
                                            document.getElementById("<%= input2Idd%>").click();
                                        });
                                    </script>
                                </form>
            ...
            <div class="row">
                    ...
                    <article class="post-item">
                        <div class="post-image">
                            <a href="single-post.html">
                                <img src="images/post-thumbnail-1.jpg" alt="image" class="post-grid-image img-fluid">
                            </a>
                        </div>
                        <div class="post-content d-flex flex-wrap gap-2 my-3">
                            ...
                            <div class="post-content">
                                ...
                                <a href="#" class="btn rounded-pill px-3 btn-primary">Read more</a>
                            </div>
                        </div>
                    </article>
                </div>
                <div class="col-md-4">
                    <article class="post-item">
                        <div class="post-image">
                            <a href="single-post.html">
                                <img src="images/post-thumbnail-2.jpg" alt="image" class="post-grid-image img-fluid">
                            </a>
                        </div>
                        <div class="post-content d-flex flex-wrap gap-2 my-3">
                            <div class="post-meta text-uppercase fs-6 text-secondary">
                ...
                <div class="col-md-4">
                    <article class="post-item">
                        <div class="post-image">
                            <a href="single-post.html">
                                <img src="images/post-thumbnail-3.jpg" alt="image" class="post-grid-image img-fluid">
                            </a>
                        </div>
                        <div class="post-content d-flex flex-wrap gap-2 my-3">
                            <div class="post-meta text-uppercase fs-6 text-secondary">
    ...
    <section class="logo-bar py-5 border-top">
        <div class="container-fluid">
            <div class="row">
                <div class="logo-content d-flex flex-wrap justify-content-between">
                    <img src="images/logo1.png" alt="logo" class="logo-image img-fluid mb-4">
                    <img src="images/logo2.png" alt="logo" class="logo-image img-fluid mb-4">
                    <img src="images/logo3.png" alt="logo" class="logo-image img-fluid mb-4">
                    <img src="images/logo4.png" alt="logo" class="logo-image img-fluid mb-4">
                    <img src="images/logo5.png" alt="logo" class="logo-image img-fluid mb-4">
                    <img src="images/logo6.png" alt="logo" class="logo-image img-fluid mb-4">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu footer-menu-001">
                        <div class="footer-intro mb-4">
                            <a href="index.html">
                                <a class="navbar-brand" href="index.html" style="margin-left:20px;"><img src="images/logo2_1.png" width="150" height="130" alt="logo">
