        ...
        <div class="page-wrapper">
            ...
            <div class="main-container">
                ...
                <div class="app-container">
                    ...
                    <%
                        String invoice = (String) request.getAttribute("idBill");
                        if (invoice == null) {
                            invoice = "";
                        }
                    %>
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                                            ...
                                                            <div class="col-sm-6 col-12">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" id="customerName" class="form-control"
                                                                           placeholder="Enter Id" name="idBill" value="<%=invoice%>"/>
                                                                </div>
                                                                <!-- Form group end -->
                                                            </div>
                                                            <div class="col-sm-6 col-12">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" id="customerName" class="form-control"
                                                                           placeholder="Enter Product Id" name="idPro"/>
                                                                </div>
                                                                <!-- Form group end -->
                                                            </div>
                                                            <div class="col-sm-6 col-12">
                                                                <!-- Form group start -->
                                                                <div class="mb-3">
                                                                    <label for="invNumber" class="form-label">Quantity</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <button type="submit" name="action" value="CreateInvoiceDetail" class="btn btn-primary">
                                                        Create Invoice
                                                    </button>
                                                </div>
                                            </div>
