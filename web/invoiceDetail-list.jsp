<%@page import="sample.invoice.InvoicedetailDTO"%>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table align-middle">
                                                ...
                                                <%
                                                    ArrayList<InvoicedetailDTO> list = (ArrayList<InvoicedetailDTO>) request.getAttribute("listInvoiceDetail");
                                                    if(list==null){
                                                        list=new ArrayList<InvoicedetailDTO>();
                                                    }
                                                    if (list.size() > 0) {
                                                %>
                                                <tbody>
