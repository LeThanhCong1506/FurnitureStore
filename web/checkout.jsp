                ...
                <div class="row g-5">
                    <div class="col-lg-6">
                        ...
                        <div class="billing-details">
                            ...
                            <input type="text" id="fname" name="fulltname" class="form-control mt-2 mb-4 ps-3" value="<%=a.getFullName()%>">
                            ...
                            <input type="text" id="adr" name="address" placeholder="House number and street name" class="form-control mt-3 ps-3 mb-3" value="<%=a.getAddress()%>">
                            <label for="email">Phone *</label>
                            <input type="text" id="phone" name="phone" class="form-control mt-2 mb-4 ps-3" value="<%=a.getPhoneNumber()%>">
                            <label for="email">Email address *</label>
                            <input type="text" id="email" name="email" class="form-control mt-2 mb-4 ps-3" value="<%=a.getEmail()%>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="your-order mt-5">
                            ...
                            <div class="total-price">
                                        ...
                                        <tr class="subtotal border-top border-bottom pt-2 pb-2 text-uppercase">
                                            ...
                                            <td data-title="Subtotal">
                                                <span class="price-amount amount ps-5">
                                                    <bdi>
                                                        <span class="price-currency-symbol">$</span><%= String.format("%.2f", totalPrice)%> </bdi>
                                                </span>
                                            </td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr class="subtotal border-top border-bottom pt-2 pb-2 text-uppercase">
                                            ...
                                            <td data-title="Subtotal">
                                                <span class="price-amount amount ps-5">
                                                    <bdi>
                                                        <span class="price-currency-symbol">$</span>0</bdi>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr class="order-total border-bottom pt-2 pb-2 text-uppercase">
                                ...
                                <button type="submit" name="action" value="CheckOut" class="btn btn-dark btn-lg text-uppercase btn-rounded-none w-100">Place an order</button>
                            </div>
                        </div>
                    </div>
                </div>
