                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <div class="col-sm-6 col-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6 col-12">
                                                                <!-- Form group start -->
                                                                <div class="mb-3">
                                                                    <label for="customerName" class="form-label">Id</label>
                                                                    <input type="text" id="customerName" class="form-control"
                                                                           placeholder="Enter Id" name="invoiceid"/>
                                                                </div>
                                                                <!-- Form group end -->
                                                            </div>
                                                            <div class="col-sm-6 col-12">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" id="customerName" class="form-control"
                                                                           placeholder="Enter Customer Name" name="username"/>
                                                                </div>
                                                                <!-- Form group end -->
                                                            </div>
                                                            <div class="col-sm-6 col-12">
                                                                <!-- Form group start -->
                                                                <div class="mb-3">
                                                                    <label for="invNumber" class="form-label">Due Date</label>
                                                            ...
                                                            <div class="col-sm-6 col-12">
                                                                <!-- Form group start -->
                                                                <div class="mb-3">
                                                                    <label for="invNumber" class="form-label">Total Price</label>
                                                                    <input type="text" id="invNumber" class="form-control"
                                                                           placeholder="Enter Invoice Number" name="totalPrice"/>
                                                                </div>
                                                                <!-- Form group end -->
                                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <button type="submit" name="action" value="CreateInvoice" class="btn btn-primary">
                                                        Create Invoice
                                                    </button>
                                                </div>
                                            </div>
