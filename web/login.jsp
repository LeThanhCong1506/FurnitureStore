                ...
                <div class="col-md-4">
                    ...
                    <form action="MainController" method="post" id="form" class="form-group flex-wrap">
                        <div class="col-12 pb-3">
                            ...
                            <input type="text" name="userName" placeholder="Write your username / email address here"
                                   class="form-control">
                        </div>
                        <div class="col-12 pb-3">
                        ...
                        <div class="col-12">
                            ...
                            %>
                            <button type="submit" name="action" value="Login" class="btn btn-dark text-uppercase w-100">Log in</button>
                            <p>Lost your password?<a href="Register" class="text-muted"> Click here</a></p>
                        </div>
