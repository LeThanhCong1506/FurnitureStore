                            ...
                            <div class="d-lg-block d-none me-2">
                                ...
                                <form action="MainController" method="POST">
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-outline-primary" type="submit" name="action" value="SearchProduct">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table align-middle">
                                                ...
                                                <%
                                                    ArrayList<InvoiceDTO> list = (ArrayList<InvoiceDTO>) request.getAttribute("invoiceList");
                                                    if (list.size() > 0) {
                                                %>
                                                <tbody>
                                                    <%
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=list.get(i).getInvoiceDate()%></td>
                                                        <td><%=list.get(i).getTotalPrice()%></td>
                                                        <td>
                                                            <form action="InvoiceDetailList" method="POST">
                                                                <button type="submit" name="id1" value="<%= list.get(i).getId()%>" class="btn btn-outline-primary">View bill</button>
                                                            </form>

                                                        </td>
                                                        <td>
                                                            <form action="MainController" method="POST">
                                                                <input type="hidden" name="id1" value="<%= list.get(i).getId()%>">
                                                                <button type="submit" name="action" value="DeleteInvoice" class="btn btn-outline-primary">Delete bill</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                    <%
